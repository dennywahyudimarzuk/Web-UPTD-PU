            ...
            <div class="collapse navbar-collapse justify-content-between">
                <div class="header-left">
                    <div class="dashboard_bar">
                        @yield('title-content', __('main.page'))
                    </div>
                </div>
                <ul class="navbar-nav header-right">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="javascript:;" id="languageDropdown" role="button"
                            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            @if (Session::get('locale') == 'id' || Session::get('locale') == '')
                                <img src="{{ asset('images/flags/id.svg') }}" class="width20 me-1" title="id"
                                    alt="id">
                            @elseif (Session::get('locale') == 'en')
                                <img src="{{ asset('images/flags/us.svg') }}" class="width20 me-1" title="en"
                                    alt="en">
                                {{-- @elseif (Session::get('locale') == 'ch')
                                <img src="{{ asset('images/flags/ch.svg') }}" class="width20 me-1" title="ch"
                                    alt="ch"> --}}
                            @endif
                        ...
                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="languageDropdown">
                            <a href="{{ route('locale', ['locale' => 'id']) }}" class="dropdown-item py-2"> <img
                                    src="{{ asset('images/flags/id.svg') }}" class="width20 me-1" title="id"
                                    alt="id"> <span class="ms-1"> Indonesia </span></a>
                            <a href="{{ route('locale', ['locale' => 'en']) }}" class="dropdown-item py-2"> <img
                                    src="{{ asset('images/flags/us.svg') }}" class="width20 me-1" title="en"
                                    alt="en"> <span class="ms-1"> English </span></a>
                            {{-- <a href="{{ route('locale', ['locale' => 'ch']) }}" class="dropdown-item py-2"> <img
                                    src="{{ asset('images/flags/ch.svg') }}" class="width20 me-1" title="en"
                                    alt="ch"> <span class="ms-1"> Mandarin </span></a> --}}
                        </div>
                    </li>
                </ul>
            </div>

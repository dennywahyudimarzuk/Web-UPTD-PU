...
@push('custom-style')
@endpush
@section('title-website', __('main.gallery'))
@section('title-content', __('main.gallery'))
@section('content')
    ...
    @include('admin.gallery.video.modal_cu')
...
@push('custom-scripts')
    <script src="{{ asset('admin/js/data-table/gallery_video.js?v=' . time()) }}"></script>
@endpush

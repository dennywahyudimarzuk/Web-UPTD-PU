...
@push('custom-style')
@endpush
@section('title-website', __('main.dashboard'))
@section('title-content', __('main.dashboard'))
@section('content')
                            ...
                            <div class="row align-items-center">
                                <div class="col-xl-6">
                                    <div class="card-bx bg-blue">
                                        <img class="pattern-img" src="{{ asset('admin/images/pattern/pattern6.png') }}"
                                            alt="">
                                        <div class="card-info text-white">
                                            <img src="{{ asset('admin/images/pattern/circle.png') }}" class="mb-4"
                                                alt="">

<!-- Mobile Menu Start -->
<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" style="background-color: #4FC0E8">
    ...
    <div class="offcanvas-body">
        ...
        <div class="header-top-info">
            <h4 style="color: #EFD256">Dinas Kependudukan dan Pencatatan Sipil</h4>
            ...
            <ul class="nav-menu">
                ...
                <li><a href="javascript:;" class="text-white">Profil</a>
                    <ul class="sub-menu" style="background-color: white">
                        <li><a href="{{ route('sejarah') }}" style="color:#4FC0E8">Sejarah</a></li>
                            <li><a href="{{ route('visi-misi') }}" style="color:#4FC0E8">Visi Misi</a></li>
                            <li><a href="{{ route('struktur') }}" style="color:#4FC0E8">Struktur Organisasi</a></li>
                    </ul>
                </li>
                <li><a href="javascript:;" class="text-white">Berita</a>
                    <ul class="sub-menu" style="background-color: white">
                        <li><a href="{{ route('kegiatan') }}" style="color:#4FC0E8">Berita DPMD</a></li>
                        <li><a href="berita/{page}" style="color:#4FC0E8">Berita Sumsel</a></li>
                    </ul>
                </li>
                <li><a href="javascript:;" class="text-white">Informasi</a>
                    <ul class="sub-menu" style="background-color: white">
                        <li><a href="{{ route('setiap-saat') }}" style="color:#4FC0E8">Informasi Setiap Saat</a></li>
                        <li><a href="{{ route('berkala') }}" style="color:#4FC0E8">Informasi Berkala</a></li>
                        <li><a href="{{ route('serta-merta') }}" style="color:#4FC0E8">Informasi Serta Merta</a></li>
                    </ul>
                </li>
                <li><a href="javascript:;" class="text-white">Galeri</a>
                    <ul class="sub-menu" style="background-color: white">
                        <li><a href="{{ route('foto') }}" style="color:#4FC0E8">Foto</a></li>
                        <li><a href="{{ route('video') }}" style="color:#4FC0E8">Video</a></li>
                    </ul>
                </li>

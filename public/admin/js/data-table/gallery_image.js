$(function() {
  ...
  $(function() {
    table = $('#dataTable').DataTable({
      ...
      ajax: window.location.origin + '/dashboard/gallery/image',
...
columns: [
    ...
    $('body').on('click', '.create', function(){
      ...
      var_url = '/dashboard/gallery/image';
    })
    ...
    $('body').on('click', '.edit', function(){
      ...
      $.ajax({
        url: window.location.origin + '/dashboard/gallery/image/'+ id +'/edit',
        type: 'GET',
        success: function(response){
          ...
          $('#modal_cu #image').show();
          $('#modal_cu #image').attr('src', window.location.origin+'/storage/gallery/images/'+response.image);
      ...
      var_url = '/dashboard/gallery/image/'+ id;
    })
    ...
    $('#modal_cu').on('hidden.bs.modal', function(){
      btn_add != "" ? btn_add.html(language == "en" ? "Create Galeri" : "Tambah Galeri") : null;
    ...
    $('body').on('click', '.delete', function(){
      ...
      swal({
        ...
        if (result.value) {
          ...
          $.ajax({
            url: window.location.origin + '/dashboard/gallery/image/' + id,
            type: "DELETE",
            dataType: 'json',
            success: function(response) {
              table.ajax.reload( null, false );
    ...
    $('body').on('click', '.status', function(){
      ...
      swal({
        ...
        if (result.value) {
          ...
          $.ajax({
            url: window.location.origin + '/dashboard/gallery/image/changed/' + id  + '/' + status,
            type: "PATCH",
            dataType: 'json',
            success: function(response) {
              table.ajax.reload( null, false );
